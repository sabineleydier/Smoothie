...
//creation de la class e utilisateur
class UserModel
{
    ...
    //fonction pour trouver l'email à partir du mot de passe.
    ...
    //fonction pour sécuriser le mot de passe.
    ...
    //fonction pour creer un compte utilisateur
    ...
    //fonction de mise à jour de la date de connexion.
    ...
    //change les coordonnées du contact séléctionné
    public function changeContact($lastName, $firstName, $address, $city, $zipCode, $phone, $UserId){
        $database = new Database();
        $sql = 'UPDATE User
            SET
            LastName = ?,
